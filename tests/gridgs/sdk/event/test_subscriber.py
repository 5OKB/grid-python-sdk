...
class TestSubscriber:
    ...
    def setup_class(cls):
        ...
        cls.event_subscriber = GridEventSubscriber(host=env.get('GRID_MQTT_HOST'), port=int(env.get('GRID_MQTT_PORT')), auth_client=cls.auth_client, satellite_id=int(env.get('GRID_SATELLITE_ID')),
                                                   ssl_settings=None, logger=logging.getLogger('event_subscriber'))
